        ...
        <div key={category}>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {items.map((item) => {
              ...
              return (
                <article
                  className="flex flex-col rounded-2xl border border-zinc-200/70 bg-white p-5 dark:border-white/10 dark:bg-zinc-900/50"
                  key={item.id}
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="shrink-0 text-right">
                      <p className="font-bold text-zinc-900 dark:text-zinc-100">${total.toFixed(0)}</p>
